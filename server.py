        ...
        while True:
            ...
            if comando == 'REGISTRAR':
                with trava:
                    ...
                    ip = endereco[0]  # Use o endereço IP do cliente que se conectou
...
def principal():
    ...
    servidor.bind(('127.0.0.1', 2000)) #Nascimento Melissa, integrante de menor idade do grupo
    servidor.listen(5)

    print("Servidor 127.0.0.1 conectado com sucesso na porta 2000")
